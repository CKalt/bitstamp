#!/usr/bin/env python3
"""
Run backtests with detailed progress tracking and time estimation
"""
import subprocess
import json
import os
...
def run_single_backtest(ma_short, ma_long, days_back=30, progress_callback=None):
        ...
        while True:
            ...
            if output:
                ...
                if "Loading data" in output:
                    print("     📂 Loading historical data...", end='\r', flush=True)
                elif "Loaded" in output and "data points" in output:
                    print("     📊 Processing price data...    ", end='\r', flush=True)
                elif "Running backtest" in output:
                    print("     🔄 Simulating trades...       ", end='\r', flush=True)
                elif "trades executed" in output:
                    print("     💹 Calculating metrics...     ", end='\r', flush=True)
